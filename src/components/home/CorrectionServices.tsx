...
import { PenLine, Calendar, MapPin, Camera, ArrowRight } from "lucide-react";

const corrections = [
  {
    title: "Name Correction",
    description: "Fix spelling mistakes or update your name as per official documents.",
    icon: PenLine,
    href: "/apply?service=correction",
  },
  {
    title: "Date of Birth Correction",
    description: "Correct your DOB on PAN card to match your birth certificate or Aadhaar.",
    icon: Calendar,
    href: "/apply?service=correction",
  },
  {
    title: "Address Correction",
    description: "Update your communication or permanent address on PAN records.",
    icon: MapPin,
    href: "/apply?service=correction",
  },
  {
    title: "Photo & Signature Update",
    description: "Replace outdated photo or signature on your PAN card.",
    icon: Camera,
    href: "/apply?service=correction",
  },
];
      ...
      <div className="container">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-display font-bold">
            Apply for Changes / Correction in PAN Card
          </h2>
          <p className="text-muted-foreground mt-3 max-w-xl mx-auto">
            Found an error on your PAN card? Update your details quickly and securely.
          </p>
        </motion.div>
